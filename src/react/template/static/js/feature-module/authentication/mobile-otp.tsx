            ...
            <div className="login-inbox">
              <div className="log-auth">
                <div className="login-verify-img">
                  <ImageWithBasePath src="assets/img/icons/phone-otp.svg" alt="mobile-icon" className="img-fluid" />
                </div>
                <div className="login-title">
                  <h3>Phone OTP Verification</h3>
                  <p className="mb-0">OTP sent to your mobile number ending <span>******9575</span></p>
                </div>
                <form method="get" className="digit-group login-form-control" data-group-name="digits" data-autosubmit="false" autoComplete="off" >
                  ...
                  <div className="reset-btn">
                    <Link to={routes.emailLogin} className="btn btn-primary w-100 justify-content-center" type="submit">Verify And Proceed</Link>
                  </div>
                </form>
              </div>
            </div>
