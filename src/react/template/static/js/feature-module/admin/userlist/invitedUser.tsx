  ...
  <div className="content container-fluid">
    <div className="page-header">
      <div className="page-title">
        <h4>Invite Users <span className="count-details">150</span></h4>
      </div>
              ...
              <table className="table datanew table-hover table-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <h2 className="table-avatar">
                        <Link to="#" className="avatar avatar-sm me-2"><img className="avatar-img rounded-circle" src="/admin/assets/img/profiles/avatar-05.jpg" alt="User Image" /></Link>
