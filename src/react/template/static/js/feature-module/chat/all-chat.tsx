...
const AllChat = () => {
  ...
  const handleSendMessage = async (event) => {
    ...
    if (inputText.trim()) {
      try {
        ...
        const url = `https://testchat-production.up.railway.app/api/whatsapp/send-template-message?templateName=statement_available_2&recipientPhoneNumber=+923008881409&parameter=${encodeURIComponent(inputText.trim())}`;
  ...
  useEffect(() => {
    ...
    // const socket = new SockJS('https://testchat-production.up.railway.app/ws'); // Use 'wss' if HTTPS
    // const stompClient = new Client({
    //   brokerURL: 'wss://testchat-production.up.railway.app/ws', // Use 'wss' if HTTPS
    //    connectHeaders: {},
    ...
    //   const recipientPhoneNumber = 'yourRecipientPhoneNumber'; // Set the actual recipient's phone number
